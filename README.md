# OpenSIPS Provisioning API

A Node.js/TypeScript provisioning and subscriber-management API that sits in front of an OpenSIPS-based softswitch, handling enterprise/subscriber CRUD, feature packages, licensing, and MySQL-backed SIP registration data.
